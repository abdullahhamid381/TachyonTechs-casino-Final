            ...
            <div className="container">
                <form action="">
                    ...
                    <div className="third">
                        <p>상세정보</p>
                        <div className="grid">
                            <input type="text" placeholder="도메인 생성일" />
                            <input type="text" placeholder="IP주소" />
                            <input type="text" placeholder="서버위치" />
                            <input type="text" placeholder="네임서버" />
                            <select name="" id="" >
                                <option value="썸네일상태" selected disabled>썸네일상태</option>
                                <option value=""></option>
                                <option value=""></option>
                            </select>
                        </div>
