  ...
  return (
    <section className="scam__form">
      ...
      <div className="container">
        ...
        <ArticlesGrid articles={communityreview} hideDescription={true} threeCol={false} date={true} border={true} />
        <div
